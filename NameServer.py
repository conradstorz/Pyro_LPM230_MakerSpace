...
while 1:
   ...
   if request == "RED": print ( remoteSquare.setRed() )
   elif request == "GREEN": print ( remoteSquare.setGreen() )
   elif request == "BLUE": print ( remoteSquare.setBlue() )
   elif request == "TIME": print ( "The square has been running for " + str ( remoteSquare.getTime() ) + " seconds" )
   else:
